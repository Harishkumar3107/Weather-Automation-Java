...
public class WeatherTest {
    ...
    public void validateWeather() {
        ...
        // This line tells us exactly what the server is saying
        ...
        if(statusCode == 200) {
            ...
            System.out.println("Current Temperature: " + apiTemp + "°C");
            
            Assert.assertTrue(apiTemp > -50 && apiTemp < 60, "Temperature value is unrealistic!");
            System.out.println("--- API Validation Passed Successfully! ---");
        } else {
            System.out.println("Error: Fetch failed. If it says 401, your API key is either wrong or not yet active.");
        }
    }
}
